...
get_header(); ?>
	...
	<section id="app-overview">
		<div class="row">
			<div class="small-24 columns">
				<h4>App Overview</h4>
				<h2>What Can MedID Do For Me?</h2>
	...
	<section id="features-overview">
		<div class="row">
			<div class="small-24 columns">
				<h4 class="section-title">Features Overview</h4>
				<h2>It’s Secure and Easy-To-Use</h2>
			</div>
			...
			<div class="small-24 columns">
				<div class="small-24 large-8 columns">
					<div class="company-wrapper">
						...
						<p>
							Access your Medical ID Card when your health insurance begins.
						</p>
					</div>
				</div>
				...
				<div class="small-24 large-8 columns">
					<div class="company-wrapper">
						...
						<p>
							Information is at your fingertips on your smart phone.
						</p>
					</div>
				</div>
				...
				<div class="small-24 large-8 columns">
					<div class="company-wrapper">
						...
						<p>
							Add other covered family members’ ID cards, so you have them all in one place.
						</p>
					</div>
				</div>
			</div>
			...
			<div class="small-24 columns">
				<div class="small-24 large-8 columns">
					<div class="company-wrapper">
						...
						<p>
							Add your – and your dependents’ – ID Cards for Dental, Vision, or other insurance coverage.
						</p>
					</div>
				</div>
				...
				<div class="small-24 large-8 columns">
					<div class="company-wrapper">
						...
						<p>
							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin suscipit sit amet mi sit amet tincidunt.
						</p>
					</div>
				</div>
				...
				<div class="small-24 large-8 columns">
					<div class="company-wrapper">
						...
						<p>
							Meets HIPAA requirements, which means your health information is secure.
						</p>
					</div>
				</div>
			</div>
	...
	<section id="how-it-works">
		<div class="row">
			...
			<div class="small-24 large-12 columns align-left">
				<h4>Simple to Set-up. Simple to Use.</h4>
	...
	<section id="all-in-one">
		<div class="row">
			...
			<div class="small-24 large-12 columns align-left">
				...
				<p>It’s super easy and much more convenient than carrying around a lot of separate cards in your wallet, purse, or pockets.
				</p>
			</div>
